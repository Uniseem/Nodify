...
export const REST_API = {
    ...
    AGENT_ENROLLMENTS: {
        CREATE: `${ROOT}/${CONTROLLERS.AGENT_ENROLLMENTS_CONTROLLER}`,
        GET: `${ROOT}/${CONTROLLERS.AGENT_ENROLLMENTS_CONTROLLER}`,
        GET_BY_UUID: (uuid: string) =>
            `${ROOT}/${CONTROLLERS.AGENT_ENROLLMENTS_CONTROLLER}/${CONTROLLERS.AGENT_ENROLLMENTS_ROUTES.GET_BY_UUID(uuid)}`,
        REVOKE: (uuid: string) =>
            `${ROOT}/${CONTROLLERS.AGENT_ENROLLMENTS_CONTROLLER}/${CONTROLLERS.AGENT_ENROLLMENTS_ROUTES.REVOKE(uuid)}`,
        PUBLIC: {
            GET: (token: string) =>
                `${ROOT}/${CONTROLLERS.PUBLIC_AGENT_ENROLLMENTS_CONTROLLER}/${CONTROLLERS.PUBLIC_AGENT_ENROLLMENTS_ROUTES.GET(token)}`,
            INSTALL: (token: string) =>
                `${ROOT}/${CONTROLLERS.PUBLIC_AGENT_ENROLLMENTS_CONTROLLER}/${CONTROLLERS.PUBLIC_AGENT_ENROLLMENTS_ROUTES.INSTALL(token)}`,
            COMPLETE: (token: string) =>
                `${ROOT}/${CONTROLLERS.PUBLIC_AGENT_ENROLLMENTS_CONTROLLER}/${CONTROLLERS.PUBLIC_AGENT_ENROLLMENTS_ROUTES.COMPLETE(token)}`,
        },
    },
    NODES: {
